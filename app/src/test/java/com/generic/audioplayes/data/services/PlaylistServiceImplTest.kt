...
import com.generic.audioplayes.assertCollectionEquals
...
class PlaylistServiceImplTest {
    ...
    init {
        ...
        coEvery { playlistDao.getMaxPosition(any()) } returns -1
        coEvery { songDao.getSongByLocation(any()) } returns null
    }
