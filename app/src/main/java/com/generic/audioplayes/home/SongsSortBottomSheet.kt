...
@Composable
private fun SortOptions.labelRes(): Int = when (this) {
    SortOptions.TitleASC -> R.string.sort_song_title_asc
    SortOptions.TitleDSC -> R.string.sort_song_title_dsc
    SortOptions.AlbumASC -> R.string.sort_album_asc
    SortOptions.AlbumDSC -> R.string.sort_album_dsc
    SortOptions.ArtistASC -> R.string.sort_artist_asc
    SortOptions.ArtistDSC -> R.string.sort_artist_dsc
    SortOptions.YearASC -> R.string.sort_year_asc
    SortOptions.YearDSC -> R.string.sort_year_dsc
    SortOptions.DurationASC -> R.string.sort_duration_asc
    SortOptions.DurationDSC -> R.string.sort_duration_dsc
    else -> R.string.sort
}

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun SongsSortBottomSheet(
    visible: Boolean,
