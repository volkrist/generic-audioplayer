...
object UiTokens {
    ...
    /** Row inside mini player (matches peek content). */
    val miniPlayerRowHeight = 72.dp
    /** Peek strip = row + thin progress (keep aligned with [HomeFragment] bottom padding math). */
    val miniPlayerPeekHeight = 76.dp
    ...
    val scaffoldBottomPaddingIdle = 88.dp
     ...
     * See [com.github.pakka_papad.home.HomeFragment].
     */
